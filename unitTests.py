...
class STOTVServerTestCase(unittest.TestCase):
    ...
    def test1_db_setup(self):
        ...
        device = server.Device(123456789012345, "Test1", "Donald Trump", "123 Where st",
                               "New York City, New York 69483")
    ...
    def test3_endpoint_rockBlock(self):
        rv = self.app.post('/api/v1/send', data=dict(imei=123456789012345, momsn=1, transmit_time="12-16-2016 16:00:00",
                                                     iridium_latitude="41.310824", iridium_longitude="-67.148437",
                                                     iridium_cep=3, data=""))
